...
export const useSettingsStore = create<SettingsState>()((set, get) => ({
  ...
  visibleTabs: ['opencode', 'claude', 'claudecode', 'codex', 'openclaw', 'image', 'ssh', 'wsl'],
  ...
  initSettings: async () => {
    ...
    try {
      ...
      set({
        ...
        visibleTabs: settings.visible_tabs ?? ['opencode', 'claude', 'claudecode', 'codex', 'openclaw', 'image', 'ssh', 'wsl'],
